  ...
  <div className='min-h-screen relative' id="home">
    ...
    {/* <div className='max-w-[1440px] 2xl:m-auto'> */}
      ...
      <div className='min-h-screen flex flex-col justify-center text-center'>
        ...
        <p className='font-body text-lg text-white-500 mt-4 md:hidden'>Graduate Student.</p>
        <p className='font-body text-lg text-white-500 md:hidden'>Software Engineer.</p>
